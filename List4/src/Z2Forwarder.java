...
public class Z2Forwarder {
  ...
  private static final int minDelay = 20;
  ...
  private Z2Forwarder(int myPort, int destPort) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    Z2Forwarder forwarder = new Z2Forwarder(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
